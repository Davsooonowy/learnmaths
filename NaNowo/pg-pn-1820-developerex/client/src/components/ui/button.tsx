...
const buttonVariants = cva(
    'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-neutral-300',
    {
        variants: {
            variant: {
                default:
                    'bg-[#3F51B5] text-white shadow hover:bg-[#3F51B5]/90 dark:bg-[#3F51B5] dark:text-white dark:hover:bg-[#3F51B5]/90',
                destructive:
                    'bg-red-500 text-neutral-50 shadow-sm hover:bg-red-500/90 dark:bg-red-900 dark:text-neutral-50 dark:hover:bg-red-900/90',
                outline:
                    'border border-[#3F51B5] bg-white shadow-sm hover:bg-[#3F51B5] hover:text-neutral-900 dark:border-[#3F51B5] dark:bg-neutral-950 dark:hover:bg-[#3F51B5] dark:hover:text-neutral-50',
                secondary:
